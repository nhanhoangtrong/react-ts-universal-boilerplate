...
const validateLoginMiddleware = (req: express.Request, res: express.Response, next: express.NextFunction) => {
...
const validateSignupMiddleware = (req: express.Request, res: express.Response, next: express.NextFunction) => {
    const payload = req.body;
    const fields: any = {};
    let valid = true;
...
route.post('/login', validateLoginMiddleware, passport.authenticate('local', { session: false, failWithError: true }), jwtSign, (req, res, next) => {
